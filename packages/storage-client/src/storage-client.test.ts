...
const hasAzurite = Boolean(process.env.AZURITE_CONNECTION_STRING);
const describeIfAzurite = hasAzurite ? describe : describe.skip;
...
describeIfAzurite("storage-client (azurite, live)", () => {
  beforeAll(() => {
